...
![Screen capture of a relay oscillator signal acquisition](doc/Relay oscillator signal acquired on Linux with higher sampling.png "Acquiring a relay oscillator signal")
