...
![Screen capture of a relay oscillator signal acquisition](doc/Slow relay oscillator signal acquired on Linux.png.png "Acquiring a relay oscillator signal")
